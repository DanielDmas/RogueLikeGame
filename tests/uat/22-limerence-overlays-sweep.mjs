// UAT 22 — LIMERENCE title-menu overlays sweep. Mirrors script 21 under
// `?pack=limerence`, including LIMERENCE's own advisory-branch About panel
// content (age advisory, mature-themes copy) rather than ANAMNESIS's.
...
await withPage(async (page) => {
  ...
  console.log(`UAT 22 (LIMERENCE overlays sweep): PASS — opened+closed ${opened.length} overlays cleanly: ${opened.join(', ')}`);
});
