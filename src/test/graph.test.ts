...
describe('room graph', () => {
  it('the graph names exactly 28 numbered rooms plus the prologue (Milestone 5, Phase K in progress: +2 Act I, +3 Act II, +3 Act III rooms so far)', () => {
