...
export function actIntroText(act: number): string | undefined {
  const fallback: Record<number, string> = {
    ...
    3: 'The floor turns to black mirror. Your own memories hang in the dark like dioramas, their faces softened past recognition. The facility calls this wing archival. It means: yours. Some of what you find here has a price you will feel, not merely see.',
