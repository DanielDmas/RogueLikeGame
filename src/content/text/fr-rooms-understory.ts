...
registerAll('v2', 'fr', {
  ...
  [roomNoteThinkersKey('the-archive')]: 'Paul Ricœur, identité narrative',
...
registerAll('v2', 'fr', {
  ...
  [roomNoteThinkersKey('the-unchosen')]: 'Søren Kierkegaard · Robert Frost, le poème mal lu comme mise en garde',
...
registerAll('v2', 'fr', {
  ...
  [roomNoteThinkersKey('the-echo')]: 'David Hume · Galen Strawson, le moi-faisceau et ses critiques',
