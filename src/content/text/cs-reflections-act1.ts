...
registerAll('v2', 'cs', {
  ...
  [reflectionKey('wallet', 'finders-fee', 'consequence')]: 'Malá srážka ze ztráty cizího člověka vám přesto vychází v plusu, porovnáte-li ji s vaším poctivě stráveným časem.',
  ...
  [reflectionKey('wallet', 'finders-fee', 'care')]: 'Jeho nájem je splatný v plné výši; váš poplatek za pohodlí není jeho dluh.',
  ...
  [reflectionKey('promotion', 'tell-friend', 'duty')]: 'Dali jste mu, co mu náleželo jako první: šanci přiznat vlastní chybu sám.',
  ...
  [reflectionKey('promotion', 'fix-it', 'care')]: 'Ochránili jste ho před bolestí, i před šancí, že by ho ta bolest něco naučila.',
