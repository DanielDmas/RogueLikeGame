...
registerAll('v2', 'fr', {
  ...
  [endingNoteThinkersKey('open-hand')]: 'Simone Weil (1947) · le problème du bodhisattva',
...
registerAll('v2', 'fr', {
  ...
  [endingNoteThinkersKey('fortress')]: 'la fortification stoïcienne · Rilke (1929) · les moi défendus',
...
registerAll('v2', 'fr', {
  ...
  [endingNoteThinkersKey('gardener')]: 'Camus (1942) · Voltaire (1759), « il faut cultiver notre jardin » · le guérisseur blessé',
