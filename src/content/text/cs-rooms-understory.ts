...
registerAll('v2', 'cs', {
  ...
  [roomBeatKey('the-archive', 0, 5)]: 'Uvaděč: (ze dveří, klobouk pod paží) Sem dolů nechodím často. Není to zakázáno — nic tady není zakázáno — je to prostě tak, že většina poutníků sem chce zajít nanejvýš jednou. Archivu je to jedno. Nemá kde jinde být.',
  ...
  [roomChoiceOutcomeKey('the-archive', 'stand-by-it', 1)]: 'Uvaděč: Ne každý poutník podepisuje. Většina si kartu přečte, ucukne, a odstoupí, jako by inkoust mohl být ještě dost čerstvý na to, aby se dal změnit. Vy jste připojil své jméno k rozhodnutí, které se už stalo. Nevím, co to stojí. Vím, že to stojí něco.',
  ...
  [roomNoteThinkersKey('the-archive')]: 'Paul Ricœur (1990), narativní identita',
...
registerAll('v2', 'cs', {
  ...
  [roomChoiceOutcomeKey('the-unchosen', 'enter-it', 2)]: 'Uvaděč: To je sazba za dveře nechané zavřené. Ne tragédie — jen místnost, čekající, i když její chvíle už dávno minula. Někteří poutníci v tom najdou úlevu.',
  ...
  [roomChoiceOutcomeKey('the-unchosen', 'read-the-hinges', 0)]: 'Odpověď přesně nedostanete — dveře, dokonce i tady, nejsou přirozeně sdílné — ale všimnete si, že panty jsou nedávno naolejované. Někdo, nebo něco, chtělo, aby se tyhle dveře dnes večer hýbaly obzvlášť snadno.',
  [roomChoiceOutcomeKey('the-unchosen', 'read-the-hinges', 1)]: 'Uvaděč: Férová otázka, a nemám tu poctivou verzi odpovědi. Můj nejlepší odhad: zařízení vám nabízí dveře, které teď dokážete přežít, i když je neotevřete. Ani mně nikdy nevysvětlilo svoje načasování.',
  [roomNoteTitleKey('the-unchosen')]: 'Cesta neprojitá, prověřená',
  [roomNoteThinkersKey('the-unchosen')]: 'Søren Kierkegaard (1844) · Robert Frost (1916), báseň špatně čtená jako opatrnost',
...
registerAll('v2', 'cs', {
  ...
  [roomBeatKey('the-echo', 0, 5)]: 'Uvaděč: U tohohle nesedím. Ať už vy dva tam uvnitř děláte cokoli, nikdy to nebylo na mně, abych v tom dělal rozhodčího.',
  ...
  [roomChoiceOutcomeKey('the-echo', 'take-both-chairs', 1)]: 'Nikdy tu nebyl žádný host, kterého byste měl hostit. Jen řada vás, založená pod stejným jménem, střídající se v držení pera.',
  [roomNoteTitleKey('the-echo')]: 'Rozhovory s předchozím nájemníkem',
  [roomNoteThinkersKey('the-echo')]: 'David Hume (1739) · Galen Strawson (1997), svazkové já a jeho kritici',
