...
registerAll('v2', 'cs', {
  ...
  [uiKey('profileReset')]: 'Váš uložený postup se nepodařilo načíst ani ze zálohy a musel být resetován. Toto je nový začátek — nic se nepodařilo obnovit.',
  ...
  [uiKey('keepsakesCarriedHeader')]: 'co jste nesli',
  ...
  [uiKey('oneDoorButton')]: 'Jedny dveře',
  ...
  [uiKey('keepsakeSpentToast')]: 'Vydáno',
  ...
  [actIntroKey(1)]: 'Před vámi: chodba bytových dveří, z nichž každé prosakuje teplým světlem domovů, které nikdy nebyly vaše. Obyčejné místnosti, zjistíte, jdou nejhlouběji. Varování, poutníku: pár těchto dveří stojí víc než čas — zvolte proti sobě, a srdce může odejít.',
  ...
  [usherBarkKey('control-low')]: 'Uvaděč: Bojujete s každou místností. Obdivuji to. Místnosti to nechávají klidnými.',
  ...
  [usherBarkKey('one-heart')]: 'Uvaděč: Zbývá jedno srdce. Nesmím se bát. Berte to za mou nejbližší možnou obavu.',
  ...
  [roomTeaserKey('editor')]: 'Škrtněte svou nejhorší vzpomínku navždy. Podívejte se, co podpírala.',
  ...
  [roomTeaserKey('butterfly-dream')]: 'Někdo tu někoho sní. Není jasné, kterým směrem.',
  [roomTitleKey('swampman')]: 'Bažinný muž',
  [roomDoorHintKey('swampman')]: 'Dveře druhého kabátu',
  [roomTeaserKey('swampman')]: 'Někdo tam uvnitř nosí vaši tvář a chová se přitom velmi zdvořile.',
  ...
  [roomDoorHintKey('free-will')]: 'Dveře, které vás viděly přicházet',
