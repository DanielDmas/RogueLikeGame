...
registerAll('v2', 'de', {
  ...
  [roomNoteThinkersKey('the-archive')]: 'Paul Ricœur, narrative Identität',
...
registerAll('v2', 'de', {
  ...
  [roomNoteThinkersKey('the-unchosen')]: 'Søren Kierkegaard · Robert Frost, das Gedicht als Vorsicht missverstanden',
...
registerAll('v2', 'de', {
  ...
  [roomNoteThinkersKey('the-echo')]: 'David Hume · Galen Strawson, das Bündel-Selbst und seine Kritiker',
