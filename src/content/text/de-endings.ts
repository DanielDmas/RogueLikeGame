...
registerAll('v2', 'de', {
  ...
  [endingNoteThinkersKey('open-hand')]: 'Simone Weil (1947) · das Bodhisattva-Problem',
...
registerAll('v2', 'de', {
  ...
  [endingNoteThinkersKey('fortress')]: 'stoische Befestigung · Rilke (1929) · verteidigte Selbste',
...
registerAll('v2', 'de', {
  ...
  [endingNoteThinkersKey('gardener')]: 'Camus (1942) · Voltaire (1759), „il faut cultiver notre jardin“ · der verwundete Heiler',
