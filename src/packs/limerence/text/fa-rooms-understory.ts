...
registerAll('v2', 'fa', {
  ...
  [roomBeatKey('the-doors-not-opened', 0, 4)]:
    'دربان: «زیاد به این‌که کدام‌یک باز شده فکر نمی‌کنم — یا برعکس، کاملاً فکر می‌کنم؛ هیچ‌وقت تصمیم نگرفته‌ام کدام توصیه بدتر است. و آن چیزِ صادقانه‌ای را می‌گویم که این طبقه همیشه بلند نمی‌گویدش: رابطه‌ی نامشروعی که نداشتید، گاهی دری است که هرگز پیشنهادتان نشده. باز‌نشده‌بودن، خودبه‌خود فضیلت نیست.»',
