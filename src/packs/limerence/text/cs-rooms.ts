...
registerAll('v2', 'cs', {
  ...
  [roomArticleTitleKey('the-read-receipt')]: 'Proč stejné ticho znamená pro různé lidi něco jiného',
  [roomArticleBodyKey('the-read-receipt')]: [
    'John Bowlby postavil teorii attachmentu (citové vazby) na neokázalém, evolučním předpokladu: lidské nemluvně, které zůstává blízko pečující osobě, přežívá spolehlivěji než to, které se toulá, takže přirozený výběr zabudoval vyhledávání blízkosti přímo do nervové soustavy, spolu s něčím, čemu Bowlby říkal „vnitřní pracovní model“ — běžící, většinou nevědomé očekávání, jestli se na natažení ruky odpoví. Toto očekávání, tvrdil, nezůstává v dětském pokoji. Stává se čočkou, po které člověk sáhne o desítky let později, kdykoli ten, koho miluje, zmlkne.',
    'Mary Ainsworthová z toho v 70. letech udělala skutečný experiment, „Podivnou situaci“: pečující osoba a nemluvně vstoupí do neznámé místnosti, pečující osoba na chvíli odejde, vstoupí cizí osoba a výzkumníci za jednosměrným zrcadlem zaznamenávají, jak přesně nemluvně zvládá odloučení a — výmluvněji — shledání. Z těch zaznamenaných shledání vzešly tři dnes proslulé vzorce — **jistý** (znepokojí ho odchod, uklidní ho návrat), **úzkostný** (znepokojí ho a nedá se snadno uklidnit, jako by návratu samotnému úplně nevěřil) a **vyhýbavý** (ukazuje jen málo viditelného rozrušení, jako by se naučil, že viditelná potřeba nebývá spolehlivě naplněna).',
    'Skok, na kterém záleží pro místnost, kterou jste právě opustili, přišel v roce 1987, kdy Cindy Hazanová a Phillip Shaver požádali dospělé, aby si přečetli tři krátké odstavce popisující různé přístupy k blízkosti v milostných vztazích, a jednoduše vybrali ten, který jim připadal nejbližší. Rozložení odpovědí dospělých se natolik podobalo rozložení u nemluvňat, že to přesvědčilo skeptický obor, že Bowlby s Ainsworthovou popsali něco, co nekončí ve třech letech — stává se z toho, řečeno slovy samotných Hazanové a Shavera, „stejný povětrnostní systém, teď už doma“. Pozdější zpřesnění Kim Bartholomewové a Leonarda Horowitze z roku 1991 rozdělilo „vyhýbavý“ styl dál, na odmítavou formu („tohle nepotřebuji“) a úzkostnou formu („tohle chci a jsem si jistý, že mě to zraní“) — protože jednodušší model neuměl rozlišit tato dvě velmi odlišná mlčení.',
    'Konkrétní mechanismus, na kterém záleží u nezodpovězené zprávy v jednu v noci, je tento: úzkostný attachment není jen „víc si dělat starosti“. Je to měřitelná hypervigilance vůči signálům dostupnosti partnera, při které je nejednoznačný signál — zpoždění, kratší než obvyklá odpověď, potvrzení o přečtení bez navazující zprávy — zpracován ne jako neutrální informace, ale spíš jako poplach. Ten poplach spolehlivě vyvolává protestní chování (kontrolování, opakované čtení, dvojité psaní zpráv), které v kruté smyčce, kterou výzkum stále nachází, často vyvolá přesně tu vzdálenost, které se snažilo předejít.',
    'Nic z toho není doživotní rozsudek. Pozdější longitudinální výzkum Mary Mainové a Ruth Goldwynové identifikoval to, čemu říkaly **„vydobytá jistota“** — dospělé, kteří v testech vycházejí jako jistě vázaní navzdory zdokumentované historii nekonzistentní nebo děsivé rané péče, téměř vždy proto, že je něco pozdějšího v životě, obvykle stabilní vztah, který přežil pár upřímně probraných těžkých nocí, naučilo jinou odpověď na tu starou otázku. **Pocit, který přijde v jednu v noci, je skutečný. Příběh, který vám vypráví o tom, proč ještě neodepsala, je jen první nástřel — a nástřely se dají přepsat.**',
  ].join('\n\n'),
});
...
registerAll('v2', 'cs', {
  ...
  [roomArticleTitleKey('the-best-friends-girl')]: 'Vědkyně, která pojmenovala to, co cítíte',
  [roomArticleBodyKey('the-best-friends-girl')]: [
    'V roce 1979 vydala psycholožka Dorothy Tennovová knihu Love and Limerence: The Experience of Being in Love, postavenou na strukturovaných rozhovorech s přibližně pěti sty lidmi o stavu, kterému záměrně dala klinické, nehodnotící jméno — ne „láska“, což jí připadalo příliš široké a příliš lichotivé, a ne „zamilovanost“ nebo „úlet“, což jí připadalo příliš odbývavé vůči něčemu, co lidé prožívali jako opravdu pohlcující. Chtěla slovo bez zabudovaného verdiktu, jen popis.',
    'Tennovové rozhovory zmapovaly pozoruhodně konzistentní shluk příznaků: vtíravé, nedobrovolné myšlení na objekt limerence, které se nedá jen tak odmyslet; akutní, konkrétní touhu po opětování, ne obecnou náklonnost; a — zjištění, které lidi obvykle překvapí nejvíc — **zesílení pod tlakem nejistoty a protivenství, ne rozpuštění.** Nejednoznačnost limerenci nevyhládoví. Živí ji, protože nevyřešený signál nechává mysli prostor zaplnit tu mezeru nadějí, a naděje, na rozdíl od jistoty, dokáže běžet velmi dlouho na velmi málo paliva. Bez péče, zjistila Tennovová, stav obvykle proběhl celým svým obloukem — nástup, „krystalizace“ a nakonec úpadek — někde mezi osmnácti měsíci a třemi lety.',
    'O desítky let později našla neurověda fyzický mechanismus, který ladí s interview daty Tennovové. Výzkum Helen Fisherové pomocí fMRI na počátku 21. století skenoval lidi, kteří uváděli, že jsou intenzivně, nově zamilovaní, a našel aktivitu soustředěnou v odměňovacích obvodech bohatých na dopamin — ventrální tegmentální oblast, nucleus caudatus — vzorce, které se výrazně překrývají s tím, co ukazují skeny u touhy po návykových látkách. To neznamená, že limerence *je* v klinickém smyslu závislost, ale znamená to, že „fyzicky na ně nedokážu přestat myslet“ je měřitelně blíž doslovné pravdě než básnickému obratu.',
    'Jeffry Simpson, a odděleně David Schmitt a David Buss ve své rozsáhlé mezikulturní studii „přetahování partnerů“ z roku 2001, zkoumali přesně ten trojúhelník, do kterého vás tahle místnost staví — zkoumaný ze všech tří rohů najednou: člověk, který touží, člověk, který už je zadaný, a partner, který o tom ještě neví. Zjištění, které by u vás mělo zůstat nejdéle, je, že skutečné, měřitelné náklady dopadají na **všechny tři** strany, do značné míry bez ohledu na to, jak se situace nakonec vyřeší. Neexistuje verze tohoto trojúhelníku, kde je vystavena jen jedna osoba.',
    'Věta, kterou stojí za to si z téhle místnosti odnést, je ta, kterou nakonec čistě vynutila data samotné Tennovové, mezi dvěma věcmi, které lidé mají sklon slévat dohromady: **stavem a chováním.** Pocit, který přijde nezván, chemicky skutečný a nedobrovolný, není morální událost. To, co uděláte s přítelkyní kamaráda, zatímco ho cítíte, je jediná část, za kterou vás kdokoli — včetně vás samotných, později — smí soudit.',
  ].join('\n\n'),
});
